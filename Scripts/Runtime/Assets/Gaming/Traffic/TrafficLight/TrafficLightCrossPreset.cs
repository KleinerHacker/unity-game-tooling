...
using System.Linq;
using UnityEngine;
using UnityGameTooling.Runtime.game_tooling.Scripts.Runtime.Components.Extras;
using UnityGameTooling.Runtime.game_tooling.Scripts.Runtime.Components.Gaming.Traffic.TrafficLight;

namespace UnityGameTooling.Runtime.game_tooling.Scripts.Runtime.Assets.Gaming.Traffic.TrafficLight
{
    [CreateAssetMenu(menuName = UnityGameToolingConstants.Menu.Asset.Gaming.Traffic.TrafficLightMenu + "/Traffic Light Cross Preset")]
