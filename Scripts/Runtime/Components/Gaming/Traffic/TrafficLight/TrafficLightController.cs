...
using UnityEngine;
using UnityGameTooling.Runtime.game_tooling.Scripts.Runtime.Assets.Gaming.Traffic.TrafficLight;
using UnityGameTooling.Runtime.game_tooling.Scripts.Runtime.Components.Gaming.Traffic.TrafficLight.Handler;
using UnityGameTooling.Runtime.game_tooling.Scripts.Runtime.Components.Gaming.Traffic.TrafficLight.Handler.Emissive;
using UnityGameTooling.Runtime.game_tooling.Scripts.Runtime.Components.Gaming.Traffic.TrafficLight.Handler.Light;

namespace UnityGameTooling.Runtime.game_tooling.Scripts.Runtime.Components.Gaming.Traffic.TrafficLight
{
    [AddComponentMenu(UnityGameToolingConstants.Menu.Component.Gaming.Traffic.TrafficLightMenu + "/Traffic Light Controller")]
